  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 dark:bg-gray-950 dark:border-gray-800">
      <nav
        ...
        ref={menuRef}
      >
        <a href="https://flexi-report-app.vercel.app/" target="_self">
          <button className="md:flex w-[auto] mt-0.5 p-0 items-center justify-center md:h-8 rounded-[20px]">
        ...
        <div className="flex flex-col">
          ...
          <div
            className={`flex-col md:flex md:flex-row gap-2 md:gap-4 xl:gap-8 ${
              menuOpen ? "flex mt-2" : "hidden"
            }`}
          >
            ...
            <button
              ...
              onClick={() =>
                window.open("https://superclient.com.br/", "_blank")
              }
            >
